...
var require_ed25519 = __commonJS({
  "node_modules/@stablelib/ed25519/lib/ed25519.js"(exports) {
    ...
    function modL(r, x2) {
      ...
      for (i2 = 63; i2 >= 32; --i2) {
        carry = 0;
        for (j3 = i2 - 32, k = i2 - 12; j3 < k; ++j3) {
          x2[j3] += carry - 16 * x2[i2] * L3[j3 - (i2 - 32)];
...
function ki(r, e) {
  ...
  function p4(c2) {
    ...
    for (var T = (_3 - v2) * d2 + 1 >>> 0, m2 = new Uint8Array(T); v2 !== _3; ) {
      for (var S4 = c2[v2], A = 0, I = T - 1; (S4 !== 0 || A < z) && I !== -1; I--, A++)
    ...
    for (var O3 = T - z; O3 !== T && m2[O3] === 0; )
      O3++;
    for (var V2 = h3.repeat(b4); O3 < T; ++O3)
      V2 += r.charAt(m2[O3]);
    return V2;
  }
  function y4(c2) {
...
var J = ({ name: r, prefix: e, encode: t, decode: i2 }) => new Hi(r, e, t, i2);
var K = ({ prefix: r, name: e, alphabet: t }) => {
  const { encode: i2, decode: s } = Bi(t, e);
  return J({ prefix: r, name: e, encode: i2, decode: (n2) => Ae(s(n2)) });
};
var Ji = (r, e, t, i2) => {
  const s = {};
...
var g2 = ({ name: r, prefix: e, bitsPerChar: t, alphabet: i2 }) => J({ prefix: e, name: r, encode(s) {
  return Wi(s, i2, t);
}, decode(s) {
  return Ji(s, i2, t, r);
} });
...
var zs = J({ prefix: "🚀", name: "base256emoji", encode: xs, decode: As });
...
function Ue(r, e, t) {
  ...
  for (; r & Fs; )
    e[t++] = r & 255 | Le, r >>>= 7;
  return e[t] = r | 0, Ue.bytes = t - i2 + 1, e;
}
var Ms = ae;
var ks = 128;
var Fe = 127;
...
var oe2 = (r, e) => {
  ...
  return Me(r, n2, 0), Me(t, n2, i2), n2.set(e, s), new Qs(r, t, e, n2);
};
var Qs = class {
  constructor(e, t, i2, s) {
...
var Zs = class {
  ...
  digest(e) {
    if (e instanceof Uint8Array) {
      ...
      return t instanceof Uint8Array ? oe2(this.code, t) : t.then((i2) => oe2(this.code, i2));
    } else
      throw Error("Unknown type, must be binary type");
  }
};
...
var Rt = class {
  constructor(e, t, i2) {
    ...
    }, this.core = e, this.logger = (0, import_logger.generateChildLogger)(t, this.name), this.keychain = i2 || new Ct(this.core, this.logger);
  }
  get context() {
    return (0, import_logger.getLoggerContext)(this.logger);
  }
...
var pr = class extends u {
  constructor(e, t) {
    super(e, t), this.relayer = e, this.logger = t, this.events = new import_events5.EventEmitter(), this.name = nt2, this.queue = /* @__PURE__ */ new Map(), this.publishTimeout = (0, import_time2.toMiliseconds)(import_time2.TEN_SECONDS), this.needsTransportRestart = false, this.publish = async (i2, s, n2) => {
      var a2;
      ...
      try {
        ...
        try {
          await await it(this.rpcPublish(i2, s, o, h3, l, d2, p4), this.publishTimeout, "Failed to publish payload, please try again."), this.removeRequestFromQueue(p4), this.relayer.events.emit(D.publish, y4);
        } catch (c2) {
...
var At2 = class extends g {
  constructor(e) {
    super(e), this.protocol = "wc", this.version = 2, this.events = new import_events5.EventEmitter(), this.name = ht, this.transportExplicitlyClosed = false, this.initialized = false, this.connectionAttemptInProgress = false, this.connectionStatusPollingInterval = 20, this.staleConnectionErrors = ["socket hang up", "socket stalled"], this.hasExperiencedNetworkDisruption = false, this.request = async (t) => {
...
var Ut = class extends p2 {
  constructor(e, t, i2, s = x, n2 = void 0) {
    super(e, t, i2, s), this.core = e, this.logger = t, this.name = i2, this.map = /* @__PURE__ */ new Map(), this.version = gt, this.cached = [], this.initialized = false, this.storagePrefix = x, this.init = async () => {
...
var Ft2 = class {
  constructor(e, t) {
    this.core = e, this.logger = t, this.name = mt2, this.version = ft2, this.events = new import_events5.default(), this.initialized = false, this.storagePrefix = x, this.ignoredPayloadTypes = [_], this.registeredMethods = [], this.init = async () => {
...
var $t2 = class extends h2 {
  constructor(e, t) {
    super(e, t), this.core = e, this.logger = t, this.records = /* @__PURE__ */ new Map(), this.events = new import_events5.EventEmitter(), this.name = Et, this.version = wt, this.cached = [], this.initialized = false, this.storagePrefix = x, this.init = async () => {
...
var Mt2 = class extends E {
  constructor(e, t) {
    super(e, t), this.core = e, this.logger = t, this.expirations = /* @__PURE__ */ new Map(), this.events = new import_events5.EventEmitter(), this.name = vt, this.version = It, this.cached = [], this.initialized = false, this.storagePrefix = x, this.init = async () => {
...
var kt2 = class extends y {
  constructor(e, t) {
    super(e, t), this.projectId = e, this.logger = t, this.name = X, this.initialized = false, this.queue = [], this.verifyDisabled = false, this.init = async (i2) => {
      if (this.verifyDisabled || H() || !q())
        return;
      const s = (i2 == null ? void 0 : i2.verifyUrl) || Q;
      ...
      await Promise.race([new Promise((n2) => {
        ...
        a2.id = X, a2.src = `${this.verifyUrl}/${this.projectId}`, a2.style.display = "none", document.body.append(a2), this.iframe = a2, i2 = n2;
...
var Z = class _Z extends n {
  constructor(e) {
    super(e), this.protocol = ce, this.version = Je, this.name = W, this.events = new import_events5.EventEmitter(), this.initialized = false, this.on = (i2, s) => this.events.on(i2, s), this.once = (i2, s) => this.events.once(i2, s), this.off = (i2, s) => this.events.off(i2, s), this.removeListener = (i2, s) => this.events.removeListener(i2, s), this.projectId = e == null ? void 0 : e.projectId, this.relayUrl = (e == null ? void 0 : e.relayUrl) || le;
    const t = typeof (e == null ? void 0 : e.logger) < "u" && typeof (e == null ? void 0 : e.logger) != "string" ? e.logger : (0, import_logger.pino)((0, import_logger.getDefaultLoggerOptions)({ level: (e == null ? void 0 : e.logger) || We.logger }));
    this.logger = (0, import_logger.generateChildLogger)(t, this.name), this.heartbeat = new import_heartbeat.HeartBeat(), this.crypto = new Rt(this, this.logger, e == null ? void 0 : e.keychain), this.history = new $t2(this, this.logger), this.expirer = new Mt2(this, this.logger), this.storage = e != null && e.storage ? e.storage : new import_keyvaluestorage.default(Vt2(Vt2({}, Xe2), e == null ? void 0 : e.storageOptions)), this.relayer = new At2({ core: this, logger: this.logger, relayUrl: this.relayUrl, projectId: this.projectId }), this.pairing = new Ft2(this, this.logger), this.verify = new kt2(this.projectId || "", this.logger);
  }
  static async init(e) {
    const t = new _Z(e);
    await t.initialize();
...
var ls2 = class extends S2 {
  constructor(r) {
    super(r), this.name = ce2, this.events = new import_events6.default(), this.initialized = false, this.ignoredPayloadTypes = [_], this.requestQueue = { state: E3.idle, queue: [] }, this.sessionRequestQueue = { state: E3.idle, queue: [] }, this.requestQueueDelay = import_time3.ONE_SECOND, this.init = async () => {
      ...
      const h3 = await this.client.core.crypto.generateKeyPair(), I = g3({ requiredNamespaces: i2, optionalNamespaces: n2, relays: a2 ?? [{ protocol: at2 }], proposer: { publicKey: h3, metadata: this.client.metadata } }, o && { sessionProperties: o }), { reject: w3, resolve: T, done: K2 } = st(import_time3.FIVE_MINUTES, oe3);
...
var Q2 = class _Q extends b {
  constructor(r) {
    super(r), this.protocol = J2, this.version = X2, this.name = M.name, this.events = new import_events6.EventEmitter(), this.on = (s, t) => this.events.on(s, t), this.once = (s, t) => this.events.once(s, t), this.off = (s, t) => this.events.off(s, t), this.removeListener = (s, t) => this.events.removeListener(s, t), this.removeAllListeners = (s) => this.events.removeAllListeners(s), this.connect = async (s) => {
      try {
...
(function(A, u3) {
  (function() {
    ...
    var Af = function h3(g5) {
      ...
      }(), be = Dt3.toString, Ef = Re4.call(M3), yf = k._, Sf = qr("^" + Re4.call(F3).replace(Ir2, "\\$&").replace(/hasOwnProperty|(function).*?(?=\\\()| for .+?(?=\\\])/g, "$1.*?") + "$"), Te = ds3 ? g5.Buffer : i2, et3 = g5.Symbol, Le2 = g5.Uint8Array, Ls2 = Te ? Te.allocUnsafe : i2, De2 = Rs2(M3.getPrototypeOf, M3), Ds2 = M3.create, Ns2 = Dt3.propertyIsEnumerable, Ne2 = Se2.splice, Hs2 = et3 ? et3.isConcatSpreadable : i2, jt3 = et3 ? et3.iterator : i2, lt3 = et3 ? et3.toStringTag : i2, He2 = function() {
        try {
          var n2 = _t2(M3, "defineProperty");
          return n2({}, "", {}), n2;
        } catch {
        }
      }(), Of = g5.clearTimeout !== k.clearTimeout && g5.clearTimeout, Rf = P3 && P3.now !== k.Date.now && P3.now, bf = g5.setTimeout !== k.setTimeout && g5.setTimeout, $e2 = X3.ceil, Ue2 = X3.floor, Br = M3.getOwnPropertySymbols, Tf = Te ? Te.isBuffer : i2, $s2 = g5.isFinite, Lf = Se2.join, Df = Rs2(M3.keys, M3), Q4 = X3.max, nn = X3.min, Nf = P3.now, Hf = g5.parseInt, Us2 = X3.random, $f = Se2.reverse, Gr = _t2(g5, "DataView"), ne2 = _t2(g5, "Map"), zr = _t2(g5, "Promise"), Nt3 = _t2(g5, "Set"), te3 = _t2(g5, "WeakMap"), ee2 = _t2(M3, "create"), We2 = te3 && new te3(), Ht2 = {}, Uf = mt3(Gr), Wf = mt3(ne2), Ff = mt3(zr), Mf = mt3(Nt3), qf = mt3(te3), Fe2 = et3 ? et3.prototype : i2, re = Fe2 ? Fe2.valueOf : i2, Ws2 = Fe2 ? Fe2.toString : i2;
      function a2(n2) {
      ...
      function zf() {
        var n2 = this.__wrapped__.value(), t = this.__dir__, e = O3(n2), r = t < 0, s = e ? n2.length : 0, o = eh(0, s, this.__views__), f3 = o.start, c2 = o.end, l = c2 - f3, v2 = r ? c2 : f3 - 1, _3 = this.__iteratees__, m2 = _3.length, w3 = 0, C3 = nn(l, this.__takeCount__);
        if (!e || !r && s == l && C3 == l)
        ...
        n:
          for (; l-- && w3 < C3; ) {
            ...
            for (var b4 = -1, y4 = n2[v2]; ++b4 < m2; ) {
              var D3 = _3[b4], H4 = D3.iteratee, dn = D3.type, sn = H4(y4);
              if (dn == $a)
                y4 = sn;
              else if (!sn) {
                if (dn == Bi2)
      ...
      N4.prototype = $t3(Me2.prototype), N4.prototype.constructor = N4;
      function pt3(n2) {
      ...
      function Fs2(n2, t) {
        var e = O3(n2), r = !e && wt2(n2), s = !e && !r && at3(n2), o = !e && !r && !s && Mt3(n2), f3 = e || r || s || o, c2 = f3 ? Wr(n2.length, Cf) : [], l = c2.length;
        for (var v2 in n2)
      ...
      function An(n2, t, e, r, s, o) {
        var f3, c2 = t & Dn2, l = t & Mn2, v2 = t & Ct2;
        ...
        var E5 = v2 ? l ? li : hi : l ? on : V2, b4 = _3 ? i2 : E5(n2);
        return mn(b4 || n2, function(y4, D3) {
          b4 && (D3 = y4, y4 = n2[D3]), ie2(f3, D3, An(y4, t, e, D3, n2, o));
        }), f3;
      }
      function _c(n2) {
        var t = V2(n2);
      ...
      function j3(n2, t, e, r, s) {
        ...
        for (e || (e = ah), s || (s = []); ++o < f3; ) {
          var c2 = n2[o];
          t > 0 && e(c2) ? t > 1 ? j3(c2, t - 1, e, r, s) : nt3(s, c2) : r || (s[s.length] = c2);
        }
        return s;
      }
      ...
      function en(n2) {
        return n2 == null ? n2 === i2 ? Ya : za : lt3 && lt3 in M3(n2) ? th(n2) : dh(n2);
      }
      function Xr(n2, t) {
        return n2 > t;
      }
      ...
      function Qr(n2, t, e) {
        for (var r = e ? Lr : xe, s = n2[0].length, o = n2.length, f3 = o, c2 = d2(o), l = 1 / 0, v2 = []; f3--; ) {
          var _3 = n2[f3];
          f3 && t && (_3 = G3(_3, hn(t))), l = nn(_3.length, l), c2[f3] = !e && (t || s >= 120 && _3.length >= 120) ? new dt3(f3 && _3) : i2;
        }
        _3 = n2[0];
        var m2 = -1, w3 = c2[0];
        n:
      ...
      function yc(n2, t, e, r, s, o) {
        var f3 = O3(n2), c2 = O3(t), l = f3 ? _e2 : tn(n2), v2 = c2 ? _e2 : tn(t);
        ...
        if (!(e & It2)) {
          ...
          if (C3 || E5) {
            ...
            return o || (o = new bn()), s(b4, y4, e, r, o);
          }
        }
      ...
      function Vr(n2, t, e, r) {
        ...
        for (; ++s < o; ) {
          ...
          if (f3 && c2[2]) {
            ...
            if (!(w3 === i2 ? ae3(_3, v2, It2 | ge2, r, m2) : w3))
              return false;
          }
        }
        return true;
      ...
      function js2(n2, t) {
        return vi(n2) && Tu(t) ? Lu(Fn2(n2), t) : function(e) {
          var r = yi(e, n2);
          return r === i2 && r === t ? Si(e, n2) : ae3(t, r, It2 | ge2);
        };
      }
      ...
      function Lc(n2, t, e, r, s, o, f3) {
        ...
        if (m2) {
          ...
          _3 = l, w3 || C3 || E5 ? O3(c2) ? _3 = c2 : Y(c2) ? _3 = un2(c2) : C3 ? (m2 = false, _3 = hu(l, true)) : E5 ? (m2 = false, _3 = lu(l, true)) : _3 = [] : le3(l) || wt2(l) ? (_3 = c2, wt2(c2) ? _3 = oa(c2) : (!z(c2) || Xn(c2)) && (_3 = bu(l))) : m2 = false;
        }
      ...
      function ri(n2, t, e, r) {
        ...
        for (var f3 = t !== t, c2 = t === null, l = pn(t), v2 = t === i2; s < o; ) {
          var _3 = Ue2((s + o) / 2), m2 = e(n2[_3]), w3 = m2 !== i2, C3 = m2 === null, E5 = m2 === m2, b4 = pn(m2);
          if (f3)
            var y4 = r || E5;
          else
            v2 ? y4 = E5 && (r || w3) : c2 ? y4 = E5 && w3 && (r || !C3) : l ? y4 = E5 && w3 && !C3 && (r || !b4) : C3 || b4 ? y4 = false : y4 = r ? m2 <= t : m2 < t;
          y4 ? s = _3 + 1 : o = _3;
        }
        return nn(o, Fa);
      }
      ...
      function ou(n2, t) {
        var e = n2;
        return e instanceof N4 && (e = e.value()), Dr2(t, function(r, s) {
      ...
      function du(n2, t, e, r) {
        for (var s = -1, o = n2.length, f3 = e.length, c2 = -1, l = t.length, v2 = Q4(o - f3, 0), _3 = d2(l + v2), m2 = !r; ++c2 < l; )
          _3[c2] = t[c2];
        for (; ++s < f3; )
          (m2 || s < o) && (_3[e[s]] = n2[s]);
        for (; v2--; )
      ...
      function gu(n2, t, e, r) {
        for (var s = -1, o = n2.length, f3 = -1, c2 = e.length, l = -1, v2 = t.length, _3 = Q4(o - c2, 0), m2 = d2(_3 + v2), w3 = !r; ++s < _3; )
          m2[s] = n2[s];
        for (var C3 = s; ++l < v2; )
          m2[C3 + l] = t[l];
        for (; ++f3 < c2; )
      ...
      function Wn(n2, t, e, r) {
        ...
        for (var o = -1, f3 = t.length; ++o < f3; ) {
          ...
          l === i2 && (l = n2[c2]), s ? Kn2(e, c2, l) : ie2(e, c2, l);
        }
        return e;
      }
      function Yc(n2, t) {
      ...
      function Xc(n2, t, e) {
        ...
        function s() {
          ...
          if (o -= v2.length, o < e)
            return Iu(n2, t, Je2, s.placeholder, i2, f3, v2, i2, i2, e - o);
        ...
        return Zn(function(t) {
          ...
          for (n2 && t.reverse(); r--; ) {
            ...
            if (typeof o != "function")
              throw new wn(U5);
            if (s && !f3 && ke3(o) == "wrapper")
              var f3 = new Pn([], true);
          }
          for (r = f3 ? r : e; ++r < e; ) {
            o = t[r];
            var c2 = ke3(o), l = c2 == "wrapper" ? pi(o) : i2;
            l && _i(l[0]) && l[1] == (qn | Nn | Hn | zt3) && !l[4].length && l[9] == 1 ? f3 = f3[ke3(l[0])].apply(f3, l[3]) : f3 = o.length == 1 && _i(o) ? f3[c2]() : f3.thru(o);
          }
          return function() {
      ...
      function Je2(n2, t, e, r, s, o, f3, c2, l, v2) {
        var _3 = t & qn, m2 = t & vn, w3 = t & ft3, C3 = t & (Nn | xt3), E5 = t & pr2, b4 = w3 ? i2 : fe(n2);
        function y4() {
          for (var D3 = arguments.length, H4 = d2(D3), dn = D3; dn--; )
            H4[dn] = arguments[dn];
          if (C3)
            var sn = Ft3(y4), gn = af(H4, sn);
          if (r && (H4 = du(H4, r, s, C3)), o && (H4 = gu(H4, o, f3, C3)), D3 -= gn, C3 && D3 < v2) {
            var Z2 = tt2(H4, sn);
            return Iu(n2, t, Je2, y4.placeholder, e, H4, Z2, c2, l, v2 - D3);
          }
          var Ln2 = m2 ? e : this, Vn2 = w3 ? Ln2[n2] : n2;
          return D3 = H4.length, c2 ? H4 = gh(H4, c2) : E5 && D3 > 1 && H4.reverse(), _3 && l < D3 && (H4.length = l), this && this !== k && this instanceof y4 && (Vn2 = b4 || fe(Vn2)), Vn2.apply(Ln2, H4);
        }
        return y4;
      }
      function Au(n2, t) {
      ...
      function Qc(n2, t, e, r) {
        var s = t & vn, o = fe(n2);
        function f3() {
          for (var c2 = -1, l = arguments.length, v2 = -1, _3 = r.length, m2 = d2(_3 + l), w3 = this && this !== k && this instanceof f3 ? o : n2; ++v2 < _3; )
            m2[v2] = r[v2];
          for (; l--; )
            m2[v2++] = arguments[++c2];
      ...
      function Cu(n2) {
        return function(t, e, r) {
          return r && typeof r != "number" && rn(t, e, r) && (e = r = i2), t = Qn(t), e === i2 ? (e = t, t = 0) : e = Qn(e), r = r === i2 ? t < e ? 1 : -1 : Qn(r), Hc(t, e, r, n2);
        };
      }
      function Ve2(n2) {
        return function(t, e) {
      ...
      function Iu(n2, t, e, r, s, o, f3, c2, l, v2) {
        var _3 = t & Nn, m2 = _3 ? f3 : i2, w3 = _3 ? i2 : f3, C3 = _3 ? o : i2, E5 = _3 ? i2 : o;
        t |= _3 ? Hn : Et2, t &= ~(_3 ? Et2 : Hn), t & qi2 || (t &= ~(vn | ft3));
        var b4 = [n2, t, s, C3, m2, E5, w3, c2, l, v2], y4 = e.apply(i2, b4);
      ...
      function Yn(n2, t, e, r, s, o, f3, c2) {
        ...
        if (!l && typeof n2 != "function")
          throw new wn(U5);
        var v2 = r ? r.length : 0;
        if (v2 || (t &= ~(Hn | Et2), r = s = i2), f3 = f3 === i2 ? f3 : Q4(R2(f3), 0), c2 = c2 === i2 ? c2 : R2(c2), v2 -= s ? s.length : 0, t & Et2) {
          var _3 = r, m2 = s;
          r = s = i2;
        }
        var w3 = l ? i2 : pi(n2), C3 = [n2, t, e, r, s, _3, m2, o, f3, c2];
        if (w3 && lh(C3, w3), n2 = C3[0], t = C3[1], e = C3[2], r = C3[3], s = C3[4], c2 = C3[9] = C3[9] === i2 ? l ? 0 : n2.length : Q4(C3[9] - v2, 0), !c2 && t & (Nn | xt3) && (t &= ~(Nn | xt3)), !t || t == vn)
          var E5 = Jc(n2, t, e);
        else
          t == Nn || t == xt3 ? E5 = Xc(n2, t, c2) : (t == Hn || t == (vn | Hn)) && !s.length ? E5 = Qc(n2, t, e, r) : E5 = Je2.apply(i2, C3);
        var b4 = w3 ? iu : Hu;
      ...
      function Su(n2, t, e, r, s, o) {
        ...
        if (v2 && _3)
          return v2 == t && _3 == n2;
        var m2 = -1, w3 = true, C3 = e & ge2 ? new dt3() : i2;
        for (o.set(n2, t), o.set(t, n2); ++m2 < c2; ) {
          var E5 = n2[m2], b4 = t[m2];
          if (r)
            var y4 = f3 ? r(b4, E5, m2, t, n2, o) : r(E5, b4, m2, n2, t, o);
          if (y4 !== i2) {
            if (y4)
              continue;
            w3 = false;
      ...
      function nh(n2, t, e, r, s, o) {
        ...
        for (var y4 = f3; ++m2 < l; ) {
          ...
          if (!(dn === i2 ? D3 === H4 || s(D3, H4, e, r, o) : dn)) {
            b4 = false;
            break;
          }
      ...
      (Gr && tn(new Gr(new ArrayBuffer(1))) != St2 || ne2 && tn(new ne2()) != Sn || zr && tn(zr.resolve()) != zi2 || Nt3 && tn(new Nt3()) != On || te3 && tn(new te3()) != Qt2) && (tn = function(n2) {
        var t = en(n2), e = t == Bn ? n2.constructor : i2, r = e ? mt3(e) : "";
        if (r)
          switch (r) {
            case Uf:
              return St2;
...
`);
      ...
      function lh(n2, t) {
        ...
        return c2 = t[5], c2 && (l = n2[5], n2[5] = l ? gu(l, c2, t[6]) : c2, n2[6] = l ? tt2(n2[5], At3) : t[6]), c2 = t[7], c2 && (n2[7] = c2), r & qn && (n2[8] = n2[8] == null ? t[8] : nn(n2[8], t[8])), n2[9] == null && (n2[9] = t[9]), n2[0] = t[0], n2[1] = s, n2;
      }
      function ph(n2) {
        var t = [];
        if (n2 != null)
      ...
      var Ph = L3(function(n2, t) {
        ...
        var e = In(t);
        return Y(e) && (e = i2), Y(n2) ? se2(n2, j3(t, 1, Y, true), x2(e, 2)) : [];
      }), Ch = L3(function(n2, t) {
        var e = In(t);
        return Y(e) && (e = i2), Y(n2) ? se2(n2, j3(t, 1, Y, true), i2, e) : [];
      });
      function Ih(n2, t, e) {
        var r = n2 == null ? 0 : n2.length;
      ...
      function qu(n2, t, e) {
        ...
        if (!r)
          return -1;
        var s = r - 1;
        return e !== i2 && (s = R2(e), s = e < 0 ? Q4(r + s, 0) : nn(s, r - 1)), Ee2(n2, x2(t, 3), s, true);
      }
      function Bu(n2) {
      ...
      function Rh(n2, t) {
        ...
        return e ? (t = t === i2 ? 1 : R2(t), j3(n2, t)) : [];
      }
      function bh(n2) {
      ...
      var Dh = L3(function(n2) {
        ...
        return t === In(e) ? t = i2 : e.pop(), e.length && e[0] === n2[0] ? Qr(e, x2(t, 2)) : [];
      }), Hh = L3(function(n2) {
        var t = In(n2), e = G3(n2, ui);
      ...
      function Uh(n2, t, e) {
        ...
        if (!r)
          return -1;
        var s = r;
        return e !== i2 && (s = R2(e), s = s < 0 ? Q4(r + s, 0) : nn(s, r - 1)), t === t ? vf(n2, t, s) : Ee2(n2, Is2, s, true);
      }
      function Wh(n2, t) {
      ...
      var il = L3(function(n2) {
        ...
        var t = In(n2);
        return Y(t) && (t = i2), it3(j3(n2, 1, Y, true), x2(t, 2));
      }), ul = L3(function(n2) {
        var t = In(n2);
        return t = typeof t == "function" ? t : i2, it3(j3(n2, 1, Y, true), i2, t);
      });
      function al(n2) {
      ...
      var cl = L3(function(n2, t) {
        ...
        var t = In(n2);
        return Y(t) && (t = i2), si(jn2(n2, Y), x2(t, 2));
      }), pl = L3(function(n2) {
        var t = In(n2);
      ...
      var wl = Zn(function(n2) {
        ...
        return t > 1 || this.__actions__.length || !(r instanceof N4) || !Jn2(e) ? this.thru(s) : (r = r.slice(e, +e + (t ? 1 : 0)), r.__actions__.push({ func: tr2, args: [s], thisArg: i2 }), new Pn(r, this.__chain__).thru(function(o) {
      ...
      function El() {
        ...
        if (n2 instanceof N4) {
          var t = n2;
          return this.__actions__.length && (t = new N4(this)), t = t.reverse(), t.__actions__.push({ func: tr2, args: [Pi], thisArg: i2 }), new Pn(t, this.__chain__);
        }
        return this.thru(Pi);
      }
      function yl() {
      ...
      function Nl(n2, t, e) {
        return e = e === i2 ? 1 : R2(e), j3(er3(n2, t), e);
      }
      function Zu(n2, t) {
        var e = O3(n2) ? mn : rt2;
        return e(n2, x2(t, 3));
      ...
      function Xu(n2, t, e) {
        return t = e ? i2 : t, t = n2 && t == null ? n2.length : t, Yn(n2, qn, i2, i2, i2, i2, t);
      }
      function Qu(n2, t) {
        var e;
        if (typeof t != "function")
      ...
      function na(n2, t, e) {
        var r, s, o, f3, c2, l, v2 = 0, _3 = false, m2 = false, w3 = true;
        if (typeof n2 != "function")
          throw new wn(U5);
        t = xn2(t) || 0, z(e) && (_3 = !!e.leading, m2 = "maxWait" in e, o = m2 ? Q4(xn2(e.maxWait) || 0, t) : o, w3 = "trailing" in e ? !!e.trailing : w3);
        function C3(Z2) {
          var Ln2 = r, Vn2 = s;
          return r = s = i2, v2 = Z2, f3 = n2.apply(Vn2, Ln2), f3;
        }
        function E5(Z2) {
          return v2 = Z2, c2 = he3(D3, t), _3 ? C3(Z2) : f3;
        }
        function b4(Z2) {
        ...
        function y4(Z2) {
          ...
          return l === i2 || Ln2 >= t || Ln2 < 0 || m2 && Vn2 >= o;
        }
        function D3() {
          var Z2 = rr2();
          if (y4(Z2))
        ...
        function H4(Z2) {
          return c2 = i2, w3 && r ? C3(Z2) : (r = s = i2, f3);
        }
        function dn() {
        ...
        function gn() {
          var Z2 = rr2(), Ln2 = y4(Z2);
          if (r = arguments, s = this, l = Z2, Ln2) {
            if (c2 === i2)
              return E5(l);
            if (m2)
              return cu(c2), c2 = he3(D3, t), C3(l);
          }
          return c2 === i2 && (c2 = he3(D3, t)), f3;
        }
      ...
      var tp = qc(function(n2, t) {
        ...
        var e = tt2(t, Ft3(Ii));
        return Yn(n2, Hn, i2, t, e);
      }), ta = L3(function(n2, t) {
        var e = tt2(t, Ft3(ta));
        return Yn(n2, Et2, i2, t, e);
      }), ep = Zn(function(n2, t) {
      ...
      function lp(n2, t) {
        return t = typeof t == "function" ? t : i2, An(n2, Dn2 | Ct2, t);
      }
      function pp(n2, t) {
      ...
      function ua(n2) {
        ...
        if (jt3 && n2[jt3])
          return pf(n2[jt3]());
        var t = tn(n2), e = t == Sn ? Mr : t == On ? ye2 : qt3;
        return e(n2);
      }
      function Qn(n2) {
        if (!n2)
      ...
      function cd(n2, t, e) {
        ...
        return (s ? mn : Un)(n2, function(f3, c2, l) {
          return t(e, f3, c2, l);
        }), e;
      }
      function hd(n2, t) {
      ...
      function gd(n2, t, e) {
        return e === i2 && (e = t, t = i2), e !== i2 && (e = xn2(e), e = e === e ? e : 0), t !== i2 && (t = xn2(t), t = t === t ? t : 0), gt2(xn2(n2), t, e);
      }
      function vd(n2, t, e) {
        return t = Qn(t), e === i2 ? (e = t, t = 0) : e = Qn(e), n2 = xn2(n2), Cc(n2, t, e);
      }
      function _d(n2, t, e) {
        if (e && typeof e != "boolean" && rn(n2, t, e) && (t = e = i2), e === i2 && (typeof t == "boolean" ? (e = t, t = i2) : typeof n2 == "boolean" && (e = n2, n2 = i2)), n2 === i2 && t === i2 ? (n2 = 0, t = 1) : (n2 = Qn(n2), t === i2 ? (t = n2, n2 = 0) : t = Qn(t)), n2 > t) {
          var r = n2;
          n2 = t, t = r;
        }
        if (e || n2 % 1 || t % 1) {
      ...
      function Rd(n2, t, e) {
        return (e ? rn(n2, t, e) : t === i2) ? t = 1 : t = R2(t), ei(W2(n2), t);
      }
      function bd() {
      ...
      function Ld(n2, t, e) {
        return e && typeof e != "number" && rn(n2, t, e) && (t = e = i2), e = e === i2 ? $n : e >>> 0, e ? (n2 = W2(n2), n2 && (typeof t == "string" || t != null && !Ei(t)) && (t = ln(t), !t && bt3(n2)) ? ut3(Rn2(n2), 0, e) : n2.split(t, e)) : [];
      }
      ...
      function Hd(n2, t, e) {
        ...
        e && rn(n2, t, e) && (t = i2), n2 = W2(n2), t = or2({}, t, r, Eu);
        var s = or2({}, t.imports, r.imports, Eu), o = V2(s), f3 = Fr(s, o), c2, l, v2 = 0, _3 = t.interpolate || Ae2, m2 = "__p += '", w3 = qr((t.escape || Ae2).source + "|" + _3.source + "|" + (_3 === Zi2 ? lo : Ae2).source + "|" + (t.evaluate || Ae2).source + "|$", "g"), C3 = "//# sourceURL=" + (F3.call(t, "sourceURL") ? (t.sourceURL + "").replace(/\s/g, " ") : "lodash.templateSources[" + ++Go + "]") + `
`;
        n2.replace(w3, function(y4, D3, H4, dn, sn, gn) {
          return H4 || (H4 = dn), m2 += n2.slice(v2, gn).replace(Po, cf), D3 && (c2 = true, m2 += `' +
__e(` + D3 + `) +
'`), sn && (l = true, m2 += `';
` + sn + `;
__p += '`), H4 && (m2 += `' +
...
`) + m2 + `return __p
        ...
        var b4 = _a(function() {
          return $3(o, C3 + "return " + m2).apply(i2, f3);
        });
        if (b4.source = m2, xi2(b4))
          throw b4;
        return b4;
      }
      function $d(n2) {
      ...
      function va(n2, t, e) {
        return n2 = W2(n2), t = e ? i2 : t, t === i2 ? lf(n2) ? Pf(n2) : ef(n2) : n2.match(t) || [];
      }
      ...
      function mg(n2) {
        return n2 && n2.length ? Be2(n2, fn, Xr) : i2;
      }
      function wg(n2, t) {
        return n2 && n2.length ? Be2(n2, x2(t, 2), Xr) : i2;
      }
      function Pg(n2) {
        return xs2(n2, fn);
      }
      ...
      function Cg(n2) {
        return n2 && n2.length ? Be2(n2, fn, jr) : i2;
      }
      function Ig(n2, t) {
        return n2 && n2.length ? Be2(n2, x2(t, 2), jr) : i2;
      }
      ...
      return a2.after = Ql, a2.ary = Xu, a2.assign = Up, a2.assignIn = fa, a2.assignInWith = or2, a2.assignWith = Wp, a2.at = Fp, a2.before = Qu, a2.bind = Ci, a2.bindAll = zd, a2.bindKey = Vu, a2.castArray = op, a2.chain = Yu, a2.chunk = _h, a2.compact = mh, a2.concat = wh, a2.cond = Kd, a2.conforms = Yd, a2.constant = Ri, a2.countBy = Sl, a2.create = Mp, a2.curry = ku, a2.curryRight = ju, a2.debounce = na, a2.defaults = qp, a2.defaultsDeep = Bp, a2.defer = Vl, a2.delay = kl, a2.difference = Ph, a2.differenceBy = Ah, a2.differenceWith = Ch, a2.drop = Ih, a2.dropRight = xh, a2.dropRightWhile = Eh, a2.dropWhile = yh, a2.fill = Sh, a2.filter = Rl, a2.flatMap = Ll, a2.flatMapDeep = Dl, a2.flatMapDepth = Nl, a2.flatten = Bu, a2.flattenDeep = Oh, a2.flattenDepth = Rh, a2.flip = jl, a2.flow = Jd, a2.flowRight = Xd, a2.fromPairs = bh, a2.functions = Xp, a2.functionsIn = Qp, a2.groupBy = Hl, a2.initial = Lh, a2.intersection = Dh, a2.intersectionBy = Nh, a2.intersectionWith = Hh, a2.invert = kp, a2.invertBy = jp, a2.invokeMap = Ul, a2.iteratee = bi, a2.keyBy = Wl, a2.keys = V2, a2.keysIn = on, a2.map = er3, a2.mapKeys = td, a2.mapValues = ed, a2.matches = Qd, a2.matchesProperty = Vd, a2.memoize = ir2, a2.merge = rd, a2.mergeWith = ca, a2.method = kd, a2.methodOf = jd, a2.mixin = Ti, a2.negate = sr2, a2.nthArg = tg, a2.omit = id, a2.omitBy = sd, a2.once = np, a2.orderBy = Fl, a2.over = eg, a2.overArgs = tp, a2.overEvery = rg, a2.overSome = ig, a2.partial = Ii, a2.partialRight = ta, a2.partition = Ml, a2.pick = ud, a2.pickBy = ha, a2.property = ma, a2.propertyOf = sg, a2.pull = Fh, a2.pullAll = zu, a2.pullAllBy = Mh, a2.pullAllWith = qh, a2.pullAt = Bh, a2.range = ug, a2.rangeRight = ag, a2.rearg = ep, a2.reject = Gl, a2.remove = Gh, a2.rest = rp, a2.reverse = Pi, a2.sampleSize = Kl, a2.set = od, a2.setWith = fd, a2.shuffle = Yl, a2.slice = zh, a2.sortBy = Xl, a2.sortedUniq = Vh, a2.sortedUniqBy = kh, a2.split = Ld, a2.spread = ip, a2.tail = jh, a2.take = nl, a2.takeRight = tl, a2.takeRightWhile = el, a2.takeWhile = rl, a2.tap = ml, a2.throttle = sp, a2.thru = tr2, a2.toArray = ua, a2.toPairs = la, a2.toPairsIn = pa, a2.toPath = lg, a2.toPlainObject = oa, a2.transform = cd, a2.unary = up, a2.union = il, a2.unionBy = sl, a2.unionWith = ul, a2.uniq = al, a2.uniqBy = ol, a2.uniqWith = fl, a2.unset = hd, a2.unzip = Ai2, a2.unzipWith = Ku, a2.update = ld, a2.updateWith = pd, a2.values = qt3, a2.valuesIn = dd, a2.without = cl, a2.words = va, a2.wrap = ap, a2.xor = hl, a2.xorBy = ll, a2.xorWith = pl, a2.zip = dl, a2.zipObject = gl, a2.zipObjectDeep = vl, a2.zipWith = _l, a2.entries = la, a2.entriesIn = pa, a2.extend = fa, a2.extendWith = or2, Ti(a2, a2), a2.add = dg, a2.attempt = _a, a2.camelCase = md, a2.capitalize = da, a2.ceil = gg, a2.clamp = gd, a2.clone = fp, a2.cloneDeep = hp, a2.cloneDeepWith = lp, a2.cloneWith = cp, a2.conformsTo = pp, a2.deburr = ga, a2.defaultTo = Zd, a2.divide = vg, a2.endsWith = wd, a2.eq = Tn, a2.escape = Pd, a2.escapeRegExp = Ad, a2.every = Ol, a2.find = bl, a2.findIndex = Mu, a2.findKey = Gp, a2.findLast = Tl, a2.findLastIndex = qu, a2.findLastKey = zp, a2.floor = _g, a2.forEach = Zu, a2.forEachRight = Ju, a2.forIn = Kp, a2.forInRight = Yp, a2.forOwn = Zp, a2.forOwnRight = Jp, a2.get = yi, a2.gt = dp, a2.gte = gp, a2.has = Vp, a2.hasIn = Si, a2.head = Gu, a2.identity = fn, a2.includes = $l, a2.indexOf = Th, a2.inRange = vd, a2.invoke = nd, a2.isArguments = wt2, a2.isArray = O3, a2.isArrayBuffer = vp, a2.isArrayLike = an2, a2.isArrayLikeObject = Y, a2.isBoolean = _p, a2.isBuffer = at3, a2.isDate = mp, a2.isElement = wp, a2.isEmpty = Pp, a2.isEqual = Ap, a2.isEqualWith = Cp, a2.isError = xi2, a2.isFinite = Ip, a2.isFunction = Xn, a2.isInteger = ea, a2.isLength = ur, a2.isMap = ra, a2.isMatch = xp, a2.isMatchWith = Ep, a2.isNaN = yp, a2.isNative = Sp, a2.isNil = Rp, a2.isNull = Op, a2.isNumber = ia, a2.isObject = z, a2.isObjectLike = K2, a2.isPlainObject = le3, a2.isRegExp = Ei, a2.isSafeInteger = bp, a2.isSet = sa, a2.isString = ar2, a2.isSymbol = pn, a2.isTypedArray = Mt3, a2.isUndefined = Tp, a2.isWeakMap = Lp, a2.isWeakSet = Dp, a2.join = $h, a2.kebabCase = Cd, a2.last = In, a2.lastIndexOf = Uh, a2.lowerCase = Id, a2.lowerFirst = xd, a2.lt = Np, a2.lte = Hp, a2.max = mg, a2.maxBy = wg, a2.mean = Pg, a2.meanBy = Ag, a2.min = Cg, a2.minBy = Ig, a2.stubArray = Di, a2.stubFalse = Ni, a2.stubObject = og, a2.stubString = fg, a2.stubTrue = cg, a2.multiply = xg, a2.nth = Wh, a2.noConflict = ng, a2.noop = Li, a2.now = rr2, a2.pad = Ed, a2.padEnd = yd, a2.padStart = Sd, a2.parseInt = Od, a2.random = _d, a2.reduce = ql, a2.reduceRight = Bl, a2.repeat = Rd, a2.replace = bd, a2.result = ad, a2.round = Eg, a2.runInContext = h3, a2.sample = zl, a2.size = Zl, a2.snakeCase = Td, a2.some = Jl, a2.sortedIndex = Kh, a2.sortedIndexBy = Yh, a2.sortedIndexOf = Zh, a2.sortedLastIndex = Jh, a2.sortedLastIndexBy = Xh, a2.sortedLastIndexOf = Qh, a2.startCase = Dd, a2.startsWith = Nd, a2.subtract = yg, a2.sum = Sg, a2.sumBy = Og, a2.template = Hd, a2.times = hg, a2.toFinite = Qn, a2.toInteger = R2, a2.toLength = aa, a2.toLower = $d, a2.toNumber = xn2, a2.toSafeInteger = $p, a2.toString = W2, a2.toUpper = Ud, a2.trim = Wd, a2.trimEnd = Fd, a2.trimStart = Md, a2.truncate = qd, a2.unescape = Bd, a2.uniqueId = pg, a2.upperCase = Gd, a2.upperFirst = Oi, a2.each = Zu, a2.eachRight = Ju, a2.first = Gu, Ti(a2, function() {
        ...
        s && (a2.prototype[t] = function() {
          ...
          if (!o && _3) {
            ...
            return y4.__actions__.push({ func: tr2, args: [m2], thisArg: i2 }), new Pn(y4, w3);
          }
          return E5 && b4 ? n2.apply(this, c2) : (y4 = this.thru(m2), E5 ? r ? y4.value()[0] : y4.value() : y4);
        });
      ...
      }), Ht2[Je2(i2, ft3).name] = [{ name: "wrapper", func: i2 }], N4.prototype.clone = Bf, N4.prototype.reverse = Gf, N4.prototype.value = zf, a2.prototype.at = wl, a2.prototype.chain = Pl, a2.prototype.commit = Al, a2.prototype.next = Cl, a2.prototype.plant = xl, a2.prototype.reverse = El, a2.prototype.toJSON = a2.prototype.valueOf = a2.prototype.value = yl, a2.prototype.first = a2.prototype.head, jt3 && (a2.prototype[jt3] = Il), a2;
    }, Lt3 = Af();
...
var ya = (A, u3, i2) => u3 in A ? Mg(A, u3, { enumerable: true, configurable: true, writable: true, value: i2 }) : A[u3] = i2;
var fr2 = (A, u3) => {
  for (var i2 in u3 || (u3 = {}))
    Gg.call(u3, i2) && ya(A, i2, u3[i2]);
  if (Ea)
    for (var i2 of Ea(u3))
      zg.call(u3, i2) && ya(A, i2, u3[i2]);
  return A;
};
...
function Yg(A, u3) {
  const i2 = Object.keys(u3.namespaces).filter((I) => I.includes(A));
  if (!i2.length)
    return [];
  const p4 = [];
  return i2.forEach((I) => {
...
function Oa(A) {
  ...
  for (const [U5, yn] of Object.entries(A)) {
    ...
    T[Mn2] = Kg(fr2(fr2({}, T[Mn2]), yn), { chains: S(Gt2, (u3 = T[Mn2]) == null ? void 0 : u3.chains), methods: S(lr, (i2 = T[Mn2]) == null ? void 0 : i2.methods), events: S(At3, (p4 = T[Mn2]) == null ? void 0 : p4.events), rpcMap: fr2(fr2({}, Dn2), (I = T[Mn2]) == null ? void 0 : I.rpcMap) });
  }
  return T;
}
function Jg(A) {
...
function Xg(A) {
  const u3 = {};
  for (const [i2, p4] of Object.entries(A)) {
    const I = p4.methods || [], T = p4.events || [], U5 = p4.accounts || [], yn = oe(i2) ? [i2] : p4.chains ? p4.chains : Sa(p4.accounts);
    u3[i2] = { chains: yn, methods: I, events: T, accounts: U5 };
  }
  return u3;
}
function Wi2(A) {
...
var Qg = class {
  ...
  setDefaultChain(u3, i2) {
    if (this.chainId = u3, !this.httpProviders[u3]) {
      const p4 = i2 || En(`${this.name}:${u3}`, this.namespace);
      if (!p4)
  ...
  createHttpProvider(u3, i2) {
    const p4 = i2 || En(u3, this.namespace);
    return typeof p4 > "u" ? void 0 : new JsonRpcProvider(new esm_default2(p4, J3("disableProviderPing")));
  }
};
var Vg = class {
  constructor(u3) {
  ...
  setDefaultChain(u3, i2) {
    ...
    if (!this.httpProviders[p4]) {
      const I = i2 || En(`${this.name}:${p4}`, this.namespace, this.client.core.projectId);
      if (!I)
  ...
  createHttpProvider(u3, i2) {
    const p4 = i2 || En(`${this.name}:${u3}`, this.namespace, this.client.core.projectId);
...
var kg = class {
  ...
  createHttpProvider(u3, i2) {
    const p4 = i2 || En(u3, this.namespace, this.client.core.projectId);
    return typeof p4 > "u" ? void 0 : new JsonRpcProvider(new esm_default2(p4, J3("disableProviderPing")));
  }
};
var jg = class {
...
var Ta = (A, u3, i2) => u3 in A ? rv(A, u3, { enumerable: true, configurable: true, writable: true, value: i2 }) : A[u3] = i2;
var cr2 = (A, u3) => {
  for (var i2 in u3 || (u3 = {}))
    uv.call(u3, i2) && Ta(A, i2, u3[i2]);
  if (ba)
    for (var i2 of ba(u3))
      av.call(u3, i2) && Ta(A, i2, u3[i2]);
  return A;
};
...
var hr2 = class _hr {
  ...
  createProviders() {
    ...
    Fi("client", this.client), Fi("events", this.events), Fi("disableProviderPing", this.disableProviderPing), u3.forEach((i2) => {
      if (!this.session)
        return;
      const p4 = Yg(i2, this.session), I = Sa(p4), T = Zg(this.namespaces, this.optionalNamespaces), U5 = Mi2(cr2({}, T[i2]), { accounts: p4, chains: I });
      switch (i2) {
        case "eip155":
        ...
        case "cosmos":
          ...
          break;
        case "polkadot":
          this.rpcProviders[i2] = new Qg({ namespace: U5 });
          break;
        case "cip34":
  ...
  registerEventListeners() {
    ...
    this.client.on("session_ping", (u3) => {
      ...
      if (p4.name === "accountsChanged") {
        ...
        const I = i2.chainId, T = i2.event.data, U5 = Xe(I), yn = Wi2(I) !== Wi2(T) ? `${U5}:${Wi2(T)}` : I;
...
var v = class _v {
  ...
  getRpcConfig(t) {
    ...
    const c2 = n2.length ? (t == null ? void 0 : t.methods) || u2 : [], o = n2.length ? (t == null ? void 0 : t.events) || m : [], r = (t == null ? void 0 : t.optionalMethods) || [], d2 = (t == null ? void 0 : t.optionalEvents) || [], C3 = (t == null ? void 0 : t.rpcMap) || this.buildRpcMap(h3, t.projectId), I = (t == null ? void 0 : t.qrModalOptions) || void 0;
  ...
  async initialize(t) {
    if (this.rpc = this.getRpcConfig(t), this.chainId = this.rpc.chains.length ? g4(this.rpc.chains) : g4(this.rpc.optionalChains), this.signer = await ov.init({ projectId: this.rpc.projectId, metadata: this.rpc.metadata, disableProviderPing: t.disableProviderPing, relayUrl: t.relayUrl, storageOptions: t.storageOptions }), this.registerEventListeners(), await this.loadPersistedSession(), this.rpc.showQrModal) {
      let s;
      try {
        const { WalletConnectModal: i2 } = await import("./dist-AS47AG6H.js");
        s = i2;
      } catch {
  ...
  getRpcUrl(t, s) {
    var i2;
    return ((i2 = this.rpc.rpcMap) == null ? void 0 : i2[t]) || `${j2}?chainId=eip155:${t}&projectId=${s || this.rpc.projectId}`;
  }
...
@walletconnect/universal-provider/dist/index.es.js:
  ...
  *)
*/
//# sourceMappingURL=index.es-XE3HT56T.js.map
