...
var oe2 = class extends LitElement {
  ...
  async onChangeRoute() {
    await animate(this.routerEl, { opacity: [1, 0], scale: [1, 1.02] }, { duration: 0.15, delay: 0.1 }).finished, this.view = T.state.view, animate(this.routerEl, { opacity: [0, 1], scale: [0.99, 1] }, { duration: 0.37, delay: 0.05 });
  }
  render() {
...
var ae = class extends LitElement {
  ...
  onOpenModalEvent() {
    this.toggleBodyScroll(false), this.addKeyboardEvents(), this.open = true, setTimeout(async () => {
      ...
      await Promise.all([animate(this.overlayEl, { opacity: [0, 1] }, { delay: o, duration: r }).finished, animate(this.containerEl, e, { delay: o, duration: r }).finished]), this.active = true;
    }, 0);
  }
  async onCloseModalEvent() {
    this.toggleBodyScroll(true), this.removeKeyboardEvents();
    const e = c.isMobileAnimation() ? { y: ["0vh", "50vh"] } : { scale: [1, 0.98] }, o = 0.2;
    await Promise.all([animate(this.overlayEl, { opacity: [1, 0] }, { duration: o }).finished, animate(this.containerEl, e, { duration: o }).finished]), this.containerEl.removeAttribute("style"), this.active = false, this.open = false;
  }
  addKeyboardEvents() {
...
//# sourceMappingURL=dist-HQ6DJVB5.js.map
