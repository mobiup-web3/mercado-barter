...
async function internal_estimateFeesPerGas(client, args) {
  ...
  const baseFeeMultiplier = await (async () => {
    ...
    return ((_b = chain == null ? void 0 : chain.fees) == null ? void 0 : _b.baseFeeMultiplier) ?? 1.2;
  })();
  ...
  if (typeof ((_a = chain == null ? void 0 : chain.fees) == null ? void 0 : _a.estimateFeesPerGas) === "function")
...
// node_modules/viem/dist/esm/actions/wallet/prepareTransactionRequest.js
...
// node_modules/viem/dist/esm/actions/wallet/sendRawTransaction.js
...
async function getSocket(url) {
  ...
  const { schedule } = createBatchScheduler({
    id: url,
    fn: async () => {
      const webSocket3 = new browser_default(url);
...
// node_modules/viem/dist/esm/actions/wallet/signTransaction.js
...
function split(name, nf, ef) {
  ...
  return name.split(STOP_CH).map((label) => {
    ...
    let norm;
    try {
      let tokens = info.tokens = process(input, nf, ef);
...
//# sourceMappingURL=chunk-6R7T53HD.js.map
