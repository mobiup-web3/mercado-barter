...
contract WrapperCoin is IERC20, Ownable, Pausable, CollateralDetails{
    ...
    * 
    */
    function burn(uint256 amount_, string memory cda_wa_document_, string memory book_, uint256 bags_) public {
    ...
    * 
    */
    function mint(uint256 amount_, string memory cda_wa_document_, string memory book_, uint256 bags_)public {
        uint256 _amount = amount_.mul(10 ** _decimals);
